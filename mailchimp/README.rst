...
.. |badge3| image:: https://img.shields.io/badge/github-CompassionCH%2Fpaid--addons-lightgray.png?logo=github
    :target: https://github.com/CompassionCH/paid-addons/tree/17.0/mailchimp
...
-  Click on Fetch audiences button to fetch your mailing lists from
   Mailchimp
-  From the Settings tab, you can control the synchronization of
   contacts between Odoo and Mailchimp. By default, modified contacts
   are exported every 4 hours.
...
3. Go to Email Marketing > Mailings and edit the campaign you want to
   schedule
4. Click on Refresh (MailChimp) button to fetch all the campaign
   information and statistics from MailChimp
...
`feedback <https://github.com/CompassionCH/paid-addons/issues/new?body=module:%20mailchimp%0Aversion:%2017.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `CompassionCH/paid-addons <https://github.com/CompassionCH/paid-addons/tree/17.0/mailchimp>`_ project on GitHub.
